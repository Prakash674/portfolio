  ...
  return (
    <footer className='w-full mb-[100px] md:mb-5 pb-10' id="contact">
      ...
      <div className='flex flex-col items-center '>
        ...
        <a href="mailto:singhprakash9572@gmail.com">
          <MagicButton
      ...
      <div className='flex mt-16 md:flex-row flex-col justify-between items-center '>
        <p className='md:text-base text-sm md:font-normal font-light '>Copyright © 2024 Prakash</p>
        <div className='flex items-center md:gap-3 gap-6'>
          {socialMedia.map((profile) => (
            <div key={profile.id}
              ...
              {/* <a href="www.google.com" target="_blank" rel="noreferrer" onClick={(e) => {
                e.preventDefault()
                console.log('clicked')
              }}> */}
              <Link
