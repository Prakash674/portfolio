  ...
  return (
    <section className="w-full py-20">
      <h1 className="heading">
        How I  <span className="text-purple">Build Your Vision </span>
      </h1>
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          title="Planning & Strategy"
          icon={<AceternityIcon order="Phase 1" />}
          description="We'all Collaborate to map out your website's goals, target audience, and key functionalities. We'll discuss things like site structure, navigation, and content requirements."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card title="Development & Progress Update"
          ...
          description="Once we agree on the plan, O cue my lofi playlist and dive into coding.From initial sketches to polished code, I keep you updated every step of the way  "
        >
